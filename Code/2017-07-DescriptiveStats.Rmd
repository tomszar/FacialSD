...
We'll save the clean coeffs for future use.

```{r saving, message=FALSE}
setwd(paste(path, "/Results/FacePCA", sep = ""))
write.csv(coeffs, file = "cleancoeffs.csv", quote = F, row.names = F)
```
