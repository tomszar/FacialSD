...
p7 <- plotsexes(MergedDat[[2]], MergedDat[[1]]$continent == "SouthAsia", "PC1", "PC2")
p8 <- plotsexes(MergedDat[[2]], MergedDat[[1]]$continent == "SouthAsia", "PC3", "PC4")
p9 <- plotsexes(MergedDat[[2]], MergedDat[[1]]$continent == "NEruope", "PC1", "PC2")
p10 <- plotsexes(MergedDat[[2]], MergedDat[[1]]$continent == "NEruope", "PC3", "PC4")
p11 <- plotsexes(MergedDat[[2]], MergedDat[[1]]$continent == "SEruope", "PC1", "PC2")
p12 <- plotsexes(MergedDat[[2]], MergedDat[[1]]$continent == "SEruope", "PC3", "PC4")
