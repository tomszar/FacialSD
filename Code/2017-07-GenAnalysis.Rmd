...
p5 <- plotcont(filter(pca.eigenvec, database != "ADAPT"), "PC9", "PC10")
p6 <- plotcont(filter(pca.eigenvec, database != "ADAPT"), "PC11", "PC12")
...
I'll divide the HapMap samples into train and test samples with a 80/20 model to assess the accuracy of our classification.
...
p5 <- plotcont(test, "PC9", "PC10")
p6 <- plotcont(test, "PC11", "PC12")
...
p5 <- plotcont(test.eur, "PC9", "PC10")
p6 <- plotcont(test.eur, "PC11", "PC12")
